 <!DOCTYPE html>
  ...
  <head>
    ...
    <body style="background-color: black;">  <div class="container">
       <form class="form-wrap " action="<?php echo base_url('pasien/index'); ?>" method="POST">
            ...
            function tampilkanwaktu(){
                ...
                echo $tahun;
                ?>
                 <center><h3><font color="white">Nilai Mahasiswa</font></h3></center>
                  ...
                  <table border="6" class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $dk->idmatkul; ?></td>
                                <td><?php echo $dk->sks; ?></td>
                                <td><?php echo $dk->total; ?></td>
                                <td><?php echo $dk->ip; ?></td>
                                <td><?php echo $dk->ipk; ?></td>
                            </tr>
                            <?php } ?>
                    ...
                    <table border="5" class="table">
                     ...
                     <center><h3><font color="white">Antrian Poli Bidan</font></h3></center>
                    <table border="5" class="table ">
                        <thead>
                            <tr>
                                <th>No</th>
